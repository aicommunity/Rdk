...
/// Переопределять глобальные настройки логов
/// (если false, то используются настройки логов приложения,
/// такие как путь до логов, флаг включения отладочного режима)
