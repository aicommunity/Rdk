#ifndef UServerTransportTcpQt_CPP
#define UServerTransportTcpQt_CPP
...
void UServerTransportTcpQt::CommandQueueTimerTimeout()
{
    try
    {
  ...
  ui(new Ui::UTcpServerControlWidget)
{
  ...
  tcpServerRestartTimer->setSingleShot(false);//����� �� ������
