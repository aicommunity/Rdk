...
void UCreateConfigurationWizardWidget::UpdateInterface(void)
{
 ...
 if(application->GetProjectOpenFlag())
 {
  ...
  ui->lineEditProjectDirectory->setText((application->GetProjectPath()+application->GetProjectFileName()).c_str());//codec->toUnicode((application->GetProjectPath()+application->GetProjectFileName()).c_str()));
