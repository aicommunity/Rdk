...
| TD-070 | Replace plaintext provider API key storage with OS-backed secure store | phase-PR2 | P0 | open | QSettings still stores API keys in plaintext; requires platform secure storage integration |
