...
**Watch plot FastPath (DD-WATCH-001):** «на график …» → `add_watch_series` (optional `create_watch_mdi`); autonomous allows UI/watch tools without burning write-step budget.
