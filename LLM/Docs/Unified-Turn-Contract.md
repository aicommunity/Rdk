...
7. **Live analogous connect (DD-CONN-002 / TD-152):** when ConnectPlan builds with `analogous_ref_token`, execute (or confirm) even under HintOnly — ReAct essay is not the primary path.
